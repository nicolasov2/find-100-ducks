...
/** 2D overlay for the spawn editor: crosshair, counter, instructions, lock prompt. */
    ...
    <>
      ...
      <div className="pointer-events-none absolute left-4 top-4 rounded-lg bg-black/60 p-3 text-white backdrop-blur-sm">
        ...
        <div className="mt-1 text-xs text-zinc-300">
          Click: marcar · <kbd>R</kbd>: borrar cercano · <kbd>Z</kbd>: deshacer · <kbd>C</kbd>: copiar + descargar
        </div>
      ...
      {!locked && (
        ...
        >
          <div className="rounded-xl border border-white/10 bg-zinc-900/90 px-6 py-4 text-center">
            ...
            <p className="mt-1 text-sm text-zinc-400">WASD moverse · mouse mirar · Esc salir</p>
            <p className="mt-2 text-xs text-zinc-500">Cuando termines, apretá <kbd>C</kbd> para copiar los puntos y pásamelos.</p>
          </div>
        </button>
      )}
      ...
      <button
        ...
        className="absolute right-4 top-4 rounded-lg bg-red-500/20 px-3 py-1.5 text-xs text-red-200 hover:bg-red-500/30"
      >
        Borrar todo
      </button>
    </>
