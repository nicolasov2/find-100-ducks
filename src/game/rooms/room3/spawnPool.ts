...
const POSITIONS: readonly Vector3Tuple[] = [
  ...
  [CX - 4, 0.08, CZ + 4.8], [CX + 4, 0.08, CZ + 4.8],
  [CX - 5.5, 0.08, CZ + 1],
  ...
  [CX + 2.5, 0.08, CZ - 4.0], [CX + 3.8, 0.08, CZ - 3.5],
  // ── Side table by desk (2) ──
  [CX + 5.5, 0.57, CZ - 4], [CX + 5.5, 0.08, CZ - 3.5],
  // ── Reading chairs (3) ──
  [CX + 3, 0.52, CZ], [CX + 4.2, 0.52, CZ - 1.8], [CX + 3, 0.52, CZ + 2.5],
  // ── Coffee table — on top and under (3) ──
  [CX + 4.5, 0.44, CZ + 1.2], [CX + 4.5, 0.08, CZ + 1.5], [CX + 4.2, 0.08, CZ + 0.8],
  // ── Fireplace — on mantel (visible from room) (3) ──
  [CX + 6.0, 1.14, CZ], [CX + 6.0, 1.14, CZ + 0.4], [CX + 6.0, 1.14, CZ - 0.4],
  // ── Fireplace floor in front (2) ──
  [CX + 5.5, 0.08, CZ + 0.5], [CX + 5.5, 0.08, CZ - 0.5],
  // ── Chests — on top, floor beside (4) ──
  [CX - 3, 0.54, CZ - 5], [CX - 3.5, 0.08, CZ - 4.5],
  [CX + 2, 0.54, CZ + 4.5], [CX + 2.5, 0.08, CZ + 4.0],
  // ── Globes (2) ──
  [CX - 2, 0.97, CZ - 3.5], [CX + 5.5, 0.97, CZ + 1.2],
  // ── Floor beside clock wall (1) ──
  [CX + 0.3, 0.08, CZ + 5.5],
  // ── Plants — beside (4) ──
  [CX - 6.2, 0.08, CZ - 5.2], [CX + 6.2, 0.08, CZ + 5.2],
  [CX + 0.5, 0.08, CZ - 5], [CX + 5.5, 0.08, CZ + 4.5],
  // ── Book stacks (3) ──
  [CX - 1, 1.22, CZ - 3], [CX + 4.5, 0.77, CZ + 1.2], [CX - 5, 0.32, CZ - 2],
  // ── Beside boxes — floor (2) ──
  [CX - 4.5, 0.08, CZ + 5.0], [CX + 5.5, 0.08, CZ - 5.0],
  // ── On boxes (2) ──
  [CX - 5, 0.45, CZ + 5], [CX + 6, 0.45, CZ - 5],
  // ── Cushions (2) ──
  [CX - 1, 0.24, CZ + 3], [CX + 1, 0.24, CZ - 2],
  // ── Lamp beside (2) ──
  [CX - 5.5, 0.08, CZ - 5], [CX + 5.5, 0.08, CZ + 5],
  // ── Dark corners (4) ──
  [CX - 6.5, 0.08, CZ - 5.5], [CX + 6.5, 0.08, CZ - 5.5],
  [CX - 6.5, 0.08, CZ + 4.5], [CX + 6.5, 0.08, CZ + 4.5],
  // ── Scattered floor (6) ──
  [CX - 2, 0.08, CZ - 1], [CX + 1, 0.08, CZ + 1],
  [CX - 4, 0.08, CZ + 2], [CX + 5, 0.08, CZ - 2],
  [CX, 0.08, CZ + 4], [CX, 0.08, CZ - 4],
  // ── Rocking chairs — on seat (2) ──
  [CX - 4, 0.55, CZ - 4], [CX + 5, 0.55, CZ - 3],
  // ── Behind rocking chairs — floor (2) ──
  [CX - 4.5, 0.08, CZ - 4.5], [CX + 5.5, 0.08, CZ - 3.5],
  // ── Poufs — on top (2) ──
  [CX - 2, 0.50, CZ + 5], [CX + 3, 0.50, CZ + 5.5],
  // ── New planter — top + side (3) ──
  [CX, 0.45, CZ - 5.5], [CX - 0.5, 0.65, CZ - 5.5], [CX + 0.5, 0.08, CZ - 5.7],
  // ── NE corner — previously empty (4) ──
  [CX + 6.5, 0.08, CZ - 5.5], [CX + 6.0, 0.08, CZ - 4.5],
